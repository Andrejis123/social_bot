...
def main(
    ...
    setup_logging()
    log.info("cli.describe_posts.start", client=client, account=account or None, sleep=sleep)
    run_id = describe_posts_for_client(client, account_handle=account or None, sleep_between=sleep)
